...
int main() {
    ...
    start = clock();
    insertionSort(arrWorst, n, "worst_case_output1000.txt");
    end = clock();
    double timeWorst = (double)(end - start) / CLOCKS_PER_SEC;

    start = clock();
    insertionSort(arrBest, n, "best_case_output1000.txt");
    end = clock();
    double timeBest = (double)(end - start) / CLOCKS_PER_SEC;

    start = clock();
    insertionSort(arrAverage, n, "average_case_output1000.txt");
    end = clock();
