...
int main() {
    ...
    start = clock();
    selectionSort(arrWorst, n, "worst_case_output10000.txt");
    end = clock();
    double timeWorst = (double)(end - start) / CLOCKS_PER_SEC;

    start = clock();
    selectionSort(arrBest, n, "best_case_output10000.txt");
    end = clock();
    double timeBest = (double)(end - start) / CLOCKS_PER_SEC;

    start = clock();
    selectionSort(arrAverage, n, "average_case_output10000.txt");
    end = clock();
